  ...
  return (
    <>
      ...
      <Grid templateColumns="repeat(3, 1fr)">
        <GridItem visibility={isShown ? "visible" : 'hidden'} colSpan={1} className='flex flex-col justify-center items-center'>
          <NewsContainer />
        </GridItem>
        <GridItem colSpan={1} className='flex flex-col justify-center items-center'>
          <AniMorse />
          <Form />
        </GridItem>
        <GridItem visibility={isShown ? "visible" : 'hidden'} colSpan={1} className='flex flex-col justify-center items-center'>
